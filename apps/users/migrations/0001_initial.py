    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions', models.CharField(choices=[('EDITOR', 'Editor'), ('VIEWER', 'Visualizador'), ('FIND', 'Buscador'), ('PRODUCTION', 'Producción')], default='EDITOR', max_length=10, verbose_name='Permisos')),
