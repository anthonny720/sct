...
const ChangePasswordForm = () => {
    ...
    const columns = [{
        name: 'current_password', title: 'Contraseña actual', type: 'password', maxLength: 50,
    }, {name: 'new_password', title: 'Nueva contraseña', type: 'password', maxLength: 50,}, {
        name: 're_new_password', title: 'Repetir nueva contraseña', type: 'password', maxLength: 50,
    },
    ...
    return (<form className="bg-white px-8 pt-6 pb-8 mb-4">
        {map(columns, (column, index) => (<div key={index}>
            ...
            <input type={column.type} maxLength={column.maxLength}
                   className="w-full p-3 mt-4 border border-gray-300 rounded outline-none focus:bg-gray-50 uppercase text-black"
